        ...
        <el-form ref="form" :model="form" label-width="80px">
            ...
            <el-form-item label="上传头像">
                <el-upload class="upload-demo" ref="upload" action="http://47.103.207.13:2008/api/nn"
                    ...
                    <el-button style="margin-left: 10px;" size="small" type="success" @click="submitUpload">确认图片
                    </el-button>
                    <div slot="tip" class="el-upload__tip">上传图片</div>
                </el-upload>
            </el-form-item>
        </el-form>
        <el-button type="danger" style="margin-left:50px" @click="correct">修改信息</el-button>
    </div>
</template>
        ...
        methods: {
            ...
            correct() {
                this.$confirm('是否修改个人资料?', '提示', {
                    ...
                    console.log(info);
                    let result = await this.$ajax.post('http://47.103.207.13:2008/api/user/updateAllinfo', {
                        info
                    })
                    console.log(result);
                    if (result.data.code == 200) {
                        result.data.data.Authorization = this.$store.user.userInfo.Authorization;
